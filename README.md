...
- [Splunk and SPL](#splunk-and-spl)
	...
	- [Practice Queries](#practice-queries)
		- [Find the account name with the highest amount of Kerberos authentication ticket requests](#find-the-account-name-with-the-highest-amount-of-kerberos-authentication-ticket-requests)
		- [Find the number of distinct computers accessed by the account name SYSTEM in all Event Code 4624 events](#find-the-number-of-distinct-computers-accessed-by-the-account-name-system-in-all-event-code-4624-events)
...
- [Intrusion Detection With Splunk](#intrusion-detection-with-splunk)
	...
	- [Further Detection Practice](#further-detection-practice)
		- [Find the other process that dumped credentials with lsass](#find-the-other-process-that-dumped-credentials-with-lsass)
		- [Find the method rundll32.exe dumped lsass](#find-the-method-rundll32exe-dumped-lsass)
		- [Find any suspicious loads of clr.dll that could be C sharp injection/execute-assembly attacks, then find the suspicious process that was used to temporarily execute code](#find-any-suspicious-loads-of-clrdll-that-could-be-c-sharp-injectionexecute-assembly-attacks-then-find-the-suspicious-process-that-was-used-to-temporarily-execute-code)
		- [Find the two IP addresses of the C2 callback server](#find-the-two-ip-addresses-of-the-c2-callback-server)
		- [Find the port that one of the two C2 server IPs used to connect to one of the compromised machines](#find-the-port-that-one-of-the-two-c2-server-ips-used-to-connect-to-one-of-the-compromised-machines)
- [Detecting Attacker TTPs](#detecting-attacker-ttps)
	...
	- [Practice Investigation](#practice-investigation)
		- [Find the password utilized during the PsExec activity](#find-the-password-utilized-during-the-psexec-activity)
- [Detecting Attacker Behavior with Anomaly Detection](#detecting-attacker-behavior-with-anomaly-detection)
	...
	- [Practice Scenario](#practice-scenario)
		- [Find the source process image that has created an unusually high number of threads in other processes (greater than 2 standard deviations)](#find-the-source-process-image-that-has-created-an-unusually-high-number-of-threads-in-other-processes-greater-than-2-standard-deviations)
